    ...
    return (
        <div data-testid="add-org-page" className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <form onSubmit={submit} data-testid="add-org-form" className="rounded-3xl border border-border bg-surface p-6 sm:p-8 space-y-6">
                ...
                <Field label="Short description (one line)" required>
                    <input data-testid="ao-short" required value={form.short} onChange={set("short")} className={inp} />
                </Field>
                <Field label="Full description" required>
                    <textarea data-testid="ao-about" required rows={5} value={form.about} onChange={set("about")} className={inp} />
                </Field>
                <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <Field label="Main contact name" required>
                        <input data-testid="ao-contact" required value={form.contactName} onChange={set("contactName")} className={inp} />
                    </Field>
                    <Field label="Contact email" required>
                        <input data-testid="ao-email" type="email" required value={form.email} onChange={set("email")} className={inp} />
                    </Field>
                </div>
                <div className="grid sm:grid-cols-2 gap-4">
                ...
                <Field label="Location / address" required>
                    <input data-testid="ao-address" required value={form.address} onChange={set("address")} className={inp} />
                </Field>
